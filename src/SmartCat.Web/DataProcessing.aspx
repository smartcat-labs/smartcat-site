            ...
            <div class="wrapper">
                <div class="main centered">
                    ...
                    <div class="rte-content">
                        <p>
                            It is hard to think of an enterprise application these days without the need for integration, both internally among many small services and externally with public APIs or 3rd party services. With the emerging of IoT and public APIs this has become a common requirement. For successful integration, data needs to be processed and this needs to be done fast, fault tolerant, usually in async and non blocking manner.  You need to fill your application with a lot of data for release, attach to public API, convert data to your data model and you are ready to go. This goes for the other end of integration, exposing data to outside world, since this data can rarely be exposed without preprocessing first. We have experience with a huge variety of public APIs, protocols and tools for data processing (messaging systems, stream computing systems, batch processing tools and reactive technologies).
                        </p>
                        <p>
