<%@ Page Title="SmartCat | Coding Serbia" Language="C#" MasterPageFile="Site.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMetaTags" runat="server" >
    <meta property="og:title" content="Sponsors at Coding Serbia" />
    <meta property="og:type" content="news" />
    <meta property="og:image" content="http://www.smartcat.io/assets/img/content/coding_serbia_detailed.jpg" />
    <meta property="og:url" content="http://www.smartcat.io/CodingSerbia.aspx" />
        ...
        <div class="content">
            <div class="wrapper o-visible">
                <div class="main article">
                    <div class="title">
                        <h2>Sponsors at Coding Serbia</h2>
                        <a href="News.aspx" class="go-back">Back</a>
                        <span class="date">05/08/15</span>
                    </div>
                    <div class="img-wrap">
                        <img src="assets/img/content/coding_serbia_detailed.jpg" alt="" />
                        <div class="badge romb"><span class="reset-inner">N.</span></div>
                    </div>
                    <div class="rte-content">
                        <p>
                            We would like to share our excitement with you. This October we will be a part of the 3rd international Coding Serbia conference in Novi Sad as silver sponsors. We have prepared some cool stuff to share with you and of course some surprises to keep you busy and entertained.  
                        </p>
                        <p>
                            We are so excited about great lectures and people that we will meet soon. Between the lectures we will wait for you at our booth to answer all of your Big Data questions, to hear your ideas and share some knowledge with you.
                        </p>
                        <p>
                            The conference will last for 2 days and will welcome more than 400 delegates each day. One of the main topics will be Big Data so we know that we will be in the right place, and so will you. See you soon.
                        </p>
                    </div>
                    <div class="article-nav">
                        <a href="OnThisDay.aspx" class="prev-post">
                            <i></i>
                            Previus post
                        </a>
                        <a href="CassandraSummit.aspx" class="next-post">
                            Next post
                            <i></i>
                        </a>
                    </div>
