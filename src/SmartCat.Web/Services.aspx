<%@ Page Title="SmartCat | Services" Language="C#" MasterPageFile="Site.master" EnableEventValidation="false" %>
            ...
            <div class="wrapper">
                <div class="main centered">
                    <div class="rte-content">
                        <p>
                            Professionalism. To the core. <br>Care. Till' the end of time...
                        </p>
                        <p>
                    ...
                    <ul class="items-list has-hover">
                        ...
                        <li class="right-aligned">
                            ...
                            <div class="text">
                                ...
                                <p>
                                    <a href="DataAnalytics.aspx">Probably the most valuable service since it can directly influence the business with new insights. This is where our team of business analysts and business intelligence experts turns data into insights by utilizing graphical representation and analysis techniques to identify the patterns that help you understand your customers, your business or your employees better.</a>
                                </p>
                                <a href="DataAnalytics.aspx" class="read-more-link">Read more <i></i></a>
                            </div>
                        </li>
                    </ul>
                </div>
