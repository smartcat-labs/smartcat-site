<%@ Page Title="SmartCat | Projects" Language="C#" MasterPageFile="Site.master" %>
            ...
            <div class="wrapper">
                <div class="main centered">
                    <ul class="items-list full">
                        <li>
                            <div class="text">
                                <h2><a href="javascript:;">Project title here</a></h2>
                                <p>
                                ...
                                <a href="javascript:;" class="read-more-link">Read more <i></i></a>
                            </div>
                        </li>
                        <li>
                            <div class="text">
